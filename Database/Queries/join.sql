...
-- join merged
Select ac.severity, ac.state_code, us.region, us.division, ac.temperature_f, ac.visibility_mi, ac.wind_speed_mph, ac.precipitation_in, ac.weather_condition, ac.sunrise_sunset, ac.year,ac.date, ac.classification
